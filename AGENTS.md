...
| Agent 的说明书 | `skills/ice-web-components-dsl/SKILL.md`、`prompts/agent-prompt.md` |
...
- `tests/compile.test.ts` —— 编译器，重点在**「一处声明两处生效」**
...
校验 → 提交这条链。canvas 里没有 DOM 目标，定位靠 `state.absoluteOrigin`
